...
; <label>:8:                                      ; preds = %1
  ...
  %11 = tail call i32 (i32, i8*, ...) @__printf_chk(i32 1, i8* %9, i8* %10, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 224) #10
...
; <label>:47:                                     ; preds = %8, %41, %44
  ...
  %51 = tail call i32 (i32, i8*, ...) @__printf_chk(i32 1, i8* %50, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.38, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.13, i64 0, i64 0)) #10
  br label %52
...
define i32 @main(i32, i8**) local_unnamed_addr #6 {
  ...
  call void @llvm.lifetime.start(i64 32, i8* nonnull %9) #10
  %10 = getelementptr inbounds [32 x i8], [32 x i8]* %7, i64 0, i64 3
...
; <label>:120:                                    ; preds = %116
  call void @llvm.lifetime.start(i64 32, i8* nonnull %102) #10
...
; <label>:410:                                    ; preds = %404
  ...
  %412 = select i1 %411, i64 28, i64 0
...
; <label>:559:                                    ; preds = %133, %507, %514, %521, %545, %548, %554
  ...
  call void @llvm.lifetime.end(i64 32, i8* nonnull %102) #10
...
; <label>:607:                                    ; preds = %606, %607
  ...
  %615 = select i1 %614, i64 28, i64 0
...
; <label>:667:                                    ; preds = %659, %113
  ...
  call void @llvm.lifetime.end(i64 32, i8* nonnull %9) #10
  ret i32 %670

; <label>:671:                                    ; preds = %353
  %672 = getelementptr inbounds i8, i8* %346, i64 2
  %673 = add nsw i32 %345, 2
  %674 = icmp ult i32 %673, 56
...
; <label>:26:                                     ; preds = %13, %11
  ...
  %29 = tail call i32 @sha224_stream(%struct._IO_FILE* %28, i8* %1) #10
  %30 = icmp eq i32 %29, 0
