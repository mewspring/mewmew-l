...
@b64c = internal unnamed_addr constant [64 x i8] c"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", align 16
...
; <label>:8:                                      ; preds = %1
  ...
  %11 = tail call i32 (i32, i8*, ...) @__printf_chk(i32 1, i8* %9, i8* %10, i32 64) #11
...
; <label>:72:                                     ; preds = %68
  %73 = icmp eq i8 %20, 0
  %74 = getelementptr inbounds [4096 x i8], [4096 x i8]* %3, i64 0, i64 0
  call void @llvm.lifetime.start(i64 4096, i8* nonnull %74) #11
  %75 = getelementptr inbounds [3072 x i8], [3072 x i8]* %4, i64 0, i64 0
  call void @llvm.lifetime.start(i64 3072, i8* nonnull %75) #11
  %76 = bitcast %struct.base64_decode_context* %5 to i8*
  call void @llvm.lifetime.start(i64 8, i8* nonnull %76) #11
  call void @base64_decode_ctx_init(%struct.base64_decode_context* nonnull %5) #11
...
; <label>:81:                                     ; preds = %121, %80
  ...
  %83 = getelementptr inbounds [4096 x i8], [4096 x i8]* %3, i64 0, i64 %82
  %84 = sub i64 4096, %82
...
; <label>:96:                                     ; preds = %105, %89
  ...
  %99 = call zeroext i1 @isbase64(i8 signext %98) #1
...
; <label>:140:                                    ; preds = %133
  store i64 3072, i64* %6, align 8
  %141 = icmp eq i32 %135, 0
  %142 = select i1 %141, i64 %113, i64 0
  %143 = call zeroext i1 @base64_decode_ctx(%struct.base64_decode_context* nonnull %5, i8* nonnull %74, i64 %142, i8* nonnull %75, i64* nonnull %6) #11
...
; <label>:160:                                    ; preds = %156
  call void @llvm.lifetime.end(i64 8, i8* nonnull %76) #11
  call void @llvm.lifetime.end(i64 3072, i8* nonnull %75) #11
  call void @llvm.lifetime.end(i64 4096, i8* nonnull %74) #11
  br label %280

; <label>:161:                                    ; preds = %68
  %162 = getelementptr inbounds [30720 x i8], [30720 x i8]* %7, i64 0, i64 0
  call void @llvm.lifetime.start(i64 30720, i8* nonnull %162) #11
  %163 = getelementptr inbounds [40960 x i8], [40960 x i8]* %8, i64 0, i64 0
  call void @llvm.lifetime.start(i64 40960, i8* nonnull %163) #11
...
; <label>:186:                                    ; preds = %184
  ...
  %188 = udiv i64 %187, 3
  %189 = shl i64 %188, 2
  call void @base64_encode(i8* nonnull %162, i64 %175, i8* nonnull %163, i64 %189) #11
...
; <label>:216:                                    ; preds = %215, %231
  ...
  %219 = getelementptr inbounds [40960 x i8], [40960 x i8]* %8, i64 0, i64 %233
...
; <label>:279:                                    ; preds = %271
  call void @llvm.lifetime.end(i64 40960, i8* nonnull %163) #11
...
; Function Attrs: nounwind sspstrong uwtable
define void @base64_encode(i8* noalias nocapture readonly, i64, i8* noalias nocapture, i64) local_unnamed_addr #6 {
  %5 = and i64 %3, 3
  %6 = icmp eq i64 %5, 0
...
; <label>:19:                                     ; preds = %18, %19
  ...
  %25 = lshr i64 %24, 2
  %26 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %25
  ...
  %38 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %37
  ...
  %49 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %48
  %50 = load i8, i8* %49, align 1
  %51 = getelementptr inbounds i8, i8* %20, i64 3
  store i8 %50, i8* %40, align 1
  %52 = and i8 %43, 63
  %53 = zext i8 %52 to i64
  %54 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %53
...
; <label>:60:                                     ; preds = %11, %129
  ...
  %67 = lshr i64 %66, 2
  %68 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %67
...
; <label>:82:                                     ; preds = %72, %77
  %83 = phi i32 [ %81, %77 ], [ 0, %72 ]
  %84 = add nuw nsw i32 %83, %75
  %85 = and i32 %84, 63
  %86 = zext i32 %85 to i64
  %87 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %86
  %88 = load i8, i8* %87, align 1
  %89 = getelementptr inbounds i8, i8* %62, i64 2
  store i8 %88, i8* %70, align 1
  %90 = icmp eq i64 %61, 2
  br i1 %90, label %142, label %91

; <label>:91:                                     ; preds = %82
  br i1 %76, label %92, label %111
...
; <label>:104:                                    ; preds = %92, %99
  %105 = phi i32 [ %103, %99 ], [ 0, %92 ]
  %106 = add nuw nsw i32 %105, %96
  %107 = and i32 %106, 63
  %108 = zext i32 %107 to i64
  %109 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %108
  %110 = load i8, i8* %109, align 1
  br label %111

; <label>:111:                                    ; preds = %91, %104
  %112 = phi i64 [ %97, %104 ], [ 0, %91 ]
  %113 = phi i8 [ %110, %104 ], [ 61, %91 ]
  %114 = getelementptr inbounds i8, i8* %62, i64 3
  store i8 %113, i8* %89, align 1
  %115 = icmp eq i64 %61, 3
...
; <label>:118:                                    ; preds = %116
  %119 = getelementptr inbounds i8, i8* %64, i64 2
  %120 = load i8, i8* %119, align 1
  %121 = and i8 %120, 63
  %122 = zext i8 %121 to i64
  %123 = getelementptr inbounds [64 x i8], [64 x i8]* @b64c, i64 0, i64 %122
  %124 = load i8, i8* %123, align 1
  br label %125

; <label>:125:                                    ; preds = %116, %118
  %126 = phi i8 [ %124, %118 ], [ 61, %116 ]
...
; <label>:129:                                    ; preds = %125
  %130 = getelementptr inbounds i8, i8* %62, i64 4
  %131 = add i64 %112, -1
  %132 = icmp eq i64 %131, 0
  %133 = xor i1 %117, true
  %134 = or i1 %132, %133
  %135 = getelementptr inbounds i8, i8* %64, i64 3
  br i1 %134, label %138, label %60
...
; Function Attrs: nounwind sspstrong uwtable
define i64 @base64_encode_alloc(i8* nocapture readonly, i64, i8** nocapture) local_unnamed_addr #6 {
  %4 = add i64 %1, 2
  %5 = udiv i64 %4, 3
  %6 = shl i64 %5, 2
  %7 = or i64 %6, 1
...
; <label>:13:                                     ; preds = %10
  tail call void @base64_encode(i8* %0, i64 %1, i8* nonnull %11, i64 %7)
  br label %14
...
define zeroext i1 @isbase64(i8 signext) local_unnamed_addr #9 {
  %2 = zext i8 %0 to i64
  %3 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %2
...
; Function Attrs: nounwind sspstrong uwtable
define void @base64_decode_ctx_init(%struct.base64_decode_context* nocapture) local_unnamed_addr #6 {
  %2 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %0, i64 0, i32 0
  store i32 0, i32* %2, align 4
  ret void
}

; Function Attrs: nounwind sspstrong uwtable
define zeroext i1 @base64_decode_ctx(%struct.base64_decode_context*, i8* noalias, i64, i8* noalias, i64* nocapture) local_unnamed_addr #6 {
  %6 = alloca i8*, align 8
  ...
  %11 = icmp ne %struct.base64_decode_context* %0, null
...
; <label>:27:                                     ; preds = %23
  ...
  %29 = call fastcc zeroext i1 @decode_4(i8* %28, i64 %26, i8** nonnull %6, i64* nonnull %7)
...
; <label>:31:                                     ; preds = %30, %31
  ...
  %37 = call fastcc zeroext i1 @decode_4(i8* %34, i64 %35, i8** nonnull %6, i64* nonnull %7)
...
; <label>:73:                                     ; preds = %69
  %74 = tail call i8* @memchr(i8* %47, i32 10, i64 4) #14
...
; <label>:93:                                     ; preds = %86
  ...
  %96 = getelementptr inbounds %struct.base64_decode_context, %struct.base64_decode_context* %0, i64 0, i32 1, i64 %95
...
; <label>:116:                                    ; preds = %112, %76
  ...
  %120 = call fastcc zeroext i1 @decode_4(i8* %119, i64 %118, i8** nonnull %6, i64* nonnull %7)
...
; Function Attrs: nounwind sspstrong uwtable
define internal fastcc zeroext i1 @decode_4(i8* noalias nocapture readonly, i64, i8** nocapture, i64* nocapture) unnamed_addr #6 {
...
; <label>:7:                                      ; preds = %4
  ...
  %9 = zext i8 %8 to i64
  %10 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %9
...
; <label>:13:                                     ; preds = %7
  ...
  %17 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %16
...
; <label>:50:                                     ; preds = %38
  ...
  %52 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %51
  %53 = load i8, i8* %52, align 1
  %54 = icmp sgt i8 %53, -1
...
; <label>:80:                                     ; preds = %73
  ...
  %82 = getelementptr inbounds [256 x i8], [256 x i8]* @b64, i64 0, i64 %81
...
; <label>:88:                                     ; preds = %86
  %89 = shl i8 %53, 6
  %90 = or i8 %89, %83
  %91 = getelementptr inbounds i8, i8* %70, i64 1
  store i8 %90, i8* %70, align 1
...
; Function Attrs: nounwind sspstrong uwtable
define zeroext i1 @base64_decode_alloc_ctx(%struct.base64_decode_context*, i8*, i64, i8** nocapture, i64*) local_unnamed_addr #6 {
  %6 = alloca i64, align 8
...
; <label>:13:                                     ; preds = %5
  %14 = call zeroext i1 @base64_decode_ctx(%struct.base64_decode_context* %0, i8* %1, i64 %2, i8* nonnull %11, i64* nonnull %6)
