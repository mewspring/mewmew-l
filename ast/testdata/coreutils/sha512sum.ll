; ModuleID = 'coreutils-8.27/src/sha512sum.bc'
...
@.str.12 = private unnamed_addr constant [10 x i8] c"sha512sum\00", align 1
...
; <label>:8:                                      ; preds = %1
  ...
  %11 = tail call i32 (i32, i8*, ...) @__printf_chk(i32 1, i8* %9, i8* %10, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 512) #10
...
define i32 @main(i32, i8**) local_unnamed_addr #6 {
  ...
  %8 = alloca i8, align 1
  %9 = getelementptr inbounds [72 x i8], [72 x i8]* %7, i64 0, i64 0
  call void @llvm.lifetime.start(i64 72, i8* nonnull %9) #10
  %10 = getelementptr inbounds [72 x i8], [72 x i8]* %7, i64 0, i64 7
...
; <label>:101:                                    ; preds = %96
  %102 = getelementptr inbounds [72 x i8], [72 x i8]* %3, i64 0, i64 0
  %103 = getelementptr inbounds [72 x i8], [72 x i8]* %3, i64 0, i64 7
...
; <label>:120:                                    ; preds = %116
  call void @llvm.lifetime.start(i64 72, i8* nonnull %102) #10
...
; <label>:261:                                    ; preds = %181
  ...
  %264 = select i1 %263, i64 130, i64 0
...
; <label>:270:                                    ; preds = %261
  ...
  %272 = select i1 %271, i64 128, i64 0
  %273 = add i64 %272, %183
...
; <label>:410:                                    ; preds = %404
  ...
  %412 = select i1 %411, i64 64, i64 0
...
; <label>:559:                                    ; preds = %133, %507, %514, %521, %545, %548, %554
  ...
  call void @llvm.lifetime.end(i64 72, i8* nonnull %102) #10
...
; <label>:607:                                    ; preds = %606, %607
  ...
  %615 = select i1 %614, i64 64, i64 0
...
; <label>:667:                                    ; preds = %659, %113
  ...
  call void @llvm.lifetime.end(i64 72, i8* nonnull %9) #10
  ret i32 %670

; <label>:671:                                    ; preds = %353
  %672 = getelementptr inbounds i8, i8* %346, i64 2
  %673 = add nsw i32 %345, 2
  %674 = icmp ult i32 %673, 128
...
; <label>:26:                                     ; preds = %13, %11
  ...
  %29 = tail call i32 @sha512_stream(%struct._IO_FILE* %28, i8* %1) #10
  %30 = icmp eq i32 %29, 0
