...
var (
	...
	_ value.Value = (*ll.InlineAsm)(nil)
	_ value.Value = (*constant.BoolConst)(nil)
	_ value.Value = (*constant.NullConst)(nil)
	_ value.Value = (*constant.NoneConst)(nil)
	_ value.Value = (*constant.StructConst)(nil)
	_ value.Value = (*constant.ArrayConst)(nil)
	_ value.Value = (*constant.CharArrayConst)(nil)
	_ value.Value = (*constant.VectorConst)(nil)
	_ value.Value = (*constant.ZeroInitializerConst)(nil)
	_ value.Value = (*ast.GlobalIdent)(nil)
	_ value.Value = (*constant.UndefConst)(nil)
	_ value.Value = (*constant.BlockAddressConst)(nil)
	_ value.Value = (*constant.AddExpr)(nil)
	_ value.Value = (*constant.FAddExpr)(nil)
	_ value.Value = (*constant.SubExpr)(nil)
	_ value.Value = (*constant.FSubExpr)(nil)
	_ value.Value = (*constant.MulExpr)(nil)
	_ value.Value = (*constant.FMulExpr)(nil)
	_ value.Value = (*constant.UDivExpr)(nil)
	_ value.Value = (*constant.SDivExpr)(nil)
	_ value.Value = (*constant.FDivExpr)(nil)
	_ value.Value = (*constant.URemExpr)(nil)
	_ value.Value = (*constant.SRemExpr)(nil)
	_ value.Value = (*constant.FRemExpr)(nil)
	_ value.Value = (*constant.ShlExpr)(nil)
	_ value.Value = (*constant.LShrExpr)(nil)
	_ value.Value = (*constant.AShrExpr)(nil)
	_ value.Value = (*constant.AndExpr)(nil)
	_ value.Value = (*constant.OrExpr)(nil)
	_ value.Value = (*constant.XorExpr)(nil)
	_ value.Value = (*constant.ExtractElementExpr)(nil)
	_ value.Value = (*constant.InsertElementExpr)(nil)
	_ value.Value = (*constant.ShuffleVectorExpr)(nil)
	_ value.Value = (*constant.ExtractValueExpr)(nil)
	_ value.Value = (*constant.InsertValueExpr)(nil)
	_ value.Value = (*constant.GetElementPtrExpr)(nil)
	_ value.Value = (*constant.TruncExpr)(nil)
	_ value.Value = (*constant.ZExtExpr)(nil)
	_ value.Value = (*constant.SExtExpr)(nil)
	_ value.Value = (*constant.FPTruncExpr)(nil)
	_ value.Value = (*constant.FPExtExpr)(nil)
	_ value.Value = (*constant.FPToUIExpr)(nil)
	_ value.Value = (*constant.FPToSIExpr)(nil)
	_ value.Value = (*constant.UIToFPExpr)(nil)
	_ value.Value = (*constant.SIToFPExpr)(nil)
	_ value.Value = (*constant.PtrToIntExpr)(nil)
	_ value.Value = (*constant.IntToPtrExpr)(nil)
	_ value.Value = (*constant.BitCastExpr)(nil)
	_ value.Value = (*constant.AddrSpaceCastExpr)(nil)
	_ value.Value = (*constant.ICmpExpr)(nil)
	_ value.Value = (*constant.FCmpExpr)(nil)
	_ value.Value = (*constant.SelectExpr)(nil)
)

// Ensure that each argument implements the ll.Argument interface.
var (
	_ ll.Argument = (*ll.Arg)(nil)
	_ ll.Argument = (*ast.TypeValue)(nil)
	_ ll.Argument = (*ast.MetadataValue)(nil)
)
