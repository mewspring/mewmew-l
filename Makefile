...
sections/01_module.bnf: sections/01_module/a_summary.bnf sections/01_module/b_source_filename.bnf sections/01_module/c_target_definition.bnf sections/01_module/d_module_asm.bnf sections/01_module/e_type_definition.bnf
	cat $^ > $@
